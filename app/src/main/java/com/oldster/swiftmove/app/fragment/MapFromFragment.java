...
import com.oldster.swiftmove.app.databinding.FragmentMapFromBinding;
...
public class MapFromFragment extends Fragment implements
        OnMapReadyCallback,
     ...
     * Variable
     ********************/
    private String TAG = MapFromFragment.class.getSimpleName();
    private FragmentMapFromBinding mBind;
     ...
     * Functions
     ********************/
    public MapFromFragment() {
        super();
    }

    @SuppressWarnings("unused")
    public static MapFromFragment newInstance() {
        MapFromFragment fragment = new MapFromFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBind = DataBindingUtil.inflate(inflater, R.layout.fragment_map_from, container, false);
    ...
    private String getNameAddress() throws IOException {
        Log.e("MapFrom", latitude + " " + longitude);
    ...
    public void onClick(View v) {
        if (v == mBind.btnConfirm) {
            if (!isProcessGetNameAddress) {
                PositionMapManager.getInstance().setNameAddressFrom(nameAddress);
                PositionMapManager.getInstance().setProvinceFrom(nameProvince);
                PositionMapManager.getInstance().setLatitudeFrom(latitude);
                PositionMapManager.getInstance().setLongitudeFrom(longitude);
